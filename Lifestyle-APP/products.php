	...
	<body>
		...
		<div class="container panel-margin">
			...
			<div class="row text-center">
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/9.jpg" alt="shirt">
						<div class="caption">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/10.jpg" alt="shirt">
						<div class="caption">
							<h3>Addam Kimmel</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/11.jpg" alt="shirt">
						<div class="caption">
							<h3>Diamond Dior</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/12.jpg" alt="shirt">
						<div class="caption">
							<h3>Quartz</h3>
							<p>Price: <i class="fa fa-rupee"></i> 12800</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
			...
			<div class="row text-center">
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/6.jpg" alt="watch">
						<div class="caption">
							<h3>H & W</h3>
							<p>Price: <i class="fa fa-rupee"></i> 1800</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/8.jpg" alt="watch">
						<div class="caption">
							<h3>Louis Phil</h3>
							<p>Price: <i class="fa fa-rupee"></i> 2500</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/13.jpg" alt="watch">
						<div class="caption">
							<h3>John Zok</h3>
							<p>Price: <i class="fa fa-rupee"></i> 3000</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/14.jpg" alt="watch">
						<div class="caption">
							<h3>Lacoste</h3>
							<p>Price: <i class="fa fa-rupee"></i> 2300</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
